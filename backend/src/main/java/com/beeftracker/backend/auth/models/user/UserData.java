...
public record UserData(
        ...
        @Transient List<Long> rolesId,
        @Transient @JsonProperty(access = JsonProperty.Access.READ_ONLY) Boolean cadastrado,
        String email,
        @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) String senha,
        @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) String tokenCriadoEm,
        @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) String tokenPrimeiroAcesso
